...
Pour tester la méthode `updateQuality` sur une liste d'items fixe, pour un nombre de jours donnés, on peut utiliser la fixture:
```
python texttest_fixture.py nb_jours
```
